...
class PersonalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create personal" do
    assert_difference('Personal.count') do
      post personals_url, params: { personal: { Date: @personal.Date, desc: @personal.desc, money: @personal.money, name: @personal.name, point: @personal.point } }
    end
  ...
  test "should update personal" do
    patch personal_url(@personal), params: { personal: { Date: @personal.Date, desc: @personal.desc, money: @personal.money, name: @personal.name, point: @personal.point } }
