...
class PromocodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promocode" do
    assert_difference('Promocode.count') do
      post promocodes_url, params: { promocode: { code: @promocode.code, credit: @promocode.credit, limitations_use: @promocode.limitations_use } }
    end
  ...
  test "should update promocode" do
    patch promocode_url(@promocode), params: { promocode: { code: @promocode.code, credit: @promocode.credit, limitations_use: @promocode.limitations_use } }
